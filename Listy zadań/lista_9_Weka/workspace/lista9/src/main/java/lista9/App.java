...
public class App {
  ...
  public static void removeSomeInstances(Instances instances) {
    ...
    for (int i = instances.numInstances() - 1; i >= 0; i--) {
      ...
      if (isLoanRejected(instance, statusPozyczki) || loanTooGreat(instance,kwotaKredytu)) {
        instances.delete(i);
      }
    }
  }

  private static boolean loanTooGreat(Instance instance,Attribute kwotaKredytu) {
